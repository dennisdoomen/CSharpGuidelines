...
severity: 1
---
Every codebase has logical or physical boundaries: a microservice, a module, a library, or a bounded context. Code within a boundary can evolve freely and share abstractions, but code that crosses a boundary should go through well-defined contracts (e.g. interfaces, DTOs, or API contracts).

Understanding these boundaries matters for several reasons:

- It prevents unnecessary coupling between components that have different lifecycles or teams.
